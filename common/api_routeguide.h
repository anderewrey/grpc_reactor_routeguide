...
#include "api_reactor.h"

/************************
 * gRPC API: Following code belongs to the API implementation
 * That code will be auto-generated by jinja files.
 ************************/
...
/************************
 * gRPC ClientReactor: Following code belongs to the API implementation
 * That code will be auto-generated by jinja files (because of the stub.async()->rpc_method() call).
 ************************/
